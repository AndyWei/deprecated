...
INSERT INTO media
    ...
    (      1, 'j5802_458440716099.jpg',             0, '750_.7',      now(), ST_SetSRID(ST_MakePoint(-122.062175637225, 37.5584115414299), 4326)),
    (      1, 'j0128_458441665579.jpg',             0, '375_.7',      now(), ST_SetSRID(ST_MakePoint(-122.062175637225, 37.5584115414299), 4326)),
    (      1, 'j6301_458441807960.jpg',             0, '375_.7',      now(), ST_SetSRID(ST_MakePoint(-122.062175637225, 37.5584115414299), 4326)),
    (      1, 'j5222_458441928465.jpg',             0, '375_.9',      now(), ST_SetSRID(ST_MakePoint(-122.062175637225, 37.5584115414299), 4326)),
    (      1, 'j2552_458446437154.jpg',             0, '375_.7',      now(), ST_SetSRID(ST_MakePoint(-122.062175637225, 37.5584115414299), 4326)),
    (      1, 'j9187_458447815669.jpg',             0, '375_.7',      now(), ST_SetSRID(ST_MakePoint(-122.062175637225, 37.5584115414299), 4326)),
    (      1, 'j2715_458447869224.jpg',             0, '375_.7',      now(), ST_SetSRID(ST_MakePoint(-122.062175637225, 37.5584115414299), 4326));
