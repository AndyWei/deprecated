CREATE TABLE person (
    ...
    org_name           TEXT          NOT NULL, -- organization name that the person belongs to. E.g., ibm, apple, twitter, stanford, etc. It's extracted from the registration email
    org_type           SMALLINT      NOT NULL DEFAULT 0, -- 0 - com,  1 - edu, 2 - org, 3 - other. This is from the email suffix
