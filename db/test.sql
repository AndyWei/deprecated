...
INSERT INTO orders
    ...
    (      1,      NULL,      0.99,       0,        1,      now(),      now(),  'jumpstart', ST_SetSRID(ST_MakePoint(-122.4164623, 37.7766092), 4326)),
    (      1,      NULL,     89.99,       0,        5,      now(),      now(),      'clean', ST_SetSRID(ST_MakePoint(-122.4074981, 37.7879331), 4326)),
