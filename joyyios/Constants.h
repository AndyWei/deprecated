...
extern NSString *const kNotificationDeletePost;
...
extern NSString *const kNotificationDidTapOnFriendCount;
extern NSString *const kNotificationDidTapOnInviteCount;
extern NSString *const kNotificationDidTapOnWinkCount;
