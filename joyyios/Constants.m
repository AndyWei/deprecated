...
NSString *const kNotificationDidTapOnFriendCount = @"didTapOnFriendCount";
NSString *const kNotificationDidTapOnInviteCount = @"didTapOnInviteCount";
NSString *const kNotificationDidTapOnWinkCount = @"didTapOnWinkCount";
