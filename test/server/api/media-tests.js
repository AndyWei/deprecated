...
lab.experiment('media GET: ', function () {
    ...
    lab.test('/media/nearby: found in San Francisco', function (done) {
    ...
    lab.test('/media/nearby: not found in Stockton', function (done) {

        request = {
            method: 'GET',
            url: '/media/nearby?lon=-121.3018775&lat=37.9730234'
        };
